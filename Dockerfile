...
FROM docker.io/hashicorp/packer:1.6.3@sha256:9d3b095a3f1e6fab44774be6874facb5cba09fa5c79f21ac459593ffc816083d AS packer
...
LABEL maintainer="first@name.tld"
